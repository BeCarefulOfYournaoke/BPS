...
TEACHER_CHECKPOINT="../checkpoints/resnet18_cifar100_200epochs.pth"

for IPC in 10 25 50 100; do
  ...
  CUDA_VISIBLE_DEVICES=${GPUS_STAGE2} python ../stage2_selection.py \
    ...
    --exp_dir ${EXP_DIR} \
    --ipc ${IPC} --seed ${SEED} \
    --entropies-path ./CIFAR100_train_entropies.npy \
